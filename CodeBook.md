# Code book for *Getting and Cleaning Data* course project on Coursera

The data set used for this project is located in the `tidydata.txt` file of this repository.
